...
<head>
  <meta charset="utf-8" />
  <title>Ksynq ${rangeLabel} Report</title>
  <style>
    :root {
      --ink: #111827;
      --muted: #4b5563;
  ...
  <div class="page">
    <div class="report-shell">
      <section class="report-header">
        <div class="report-kicker">Ksynq Analytics</div>
      ...
      <div class="footnote">Generated by Ksynq | ${rangeLabel} report | ${payload.summary.rangeDays} day window</div>
    </div>
  </div>
</body>
</html>`;
  ...
  try {
    ...
    res.status(200).json({
      ...
      data: {
        range,
        html,
        fileName: `ksynq-${range}-report.html`,
      }
    });
  } catch (err) {
