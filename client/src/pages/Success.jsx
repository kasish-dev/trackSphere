...
const Success = () => {
  ...
  const currentTier = localUser?.user?.subscriptionTier || 'PRO';
      ...
      >
        ...
        <div className="bg-gray-50 dark:bg-gray-900/50 rounded-2xl p-6 text-left mb-8 space-y-4">
          <h3 className="font-bold text-gray-900 dark:text-white flex items-center gap-2">
            <Zap size={20} className="text-yellow-500" /> Premium Features Unlocked
          </h3>
          <ul className="space-y-3">
            <li className="flex items-start gap-3 text-sm text-gray-600 dark:text-gray-300">
              ...
              <span>Your account now has expanded premium access based on the selected plan.</span>
            </li>
            <li className="flex items-start gap-3 text-sm text-gray-600 dark:text-gray-300">
              <ShieldCheck size={20} className="text-green-500 shrink-0" />
              <span>Higher group limits, richer history access, and stronger operational features are now available.</span>
            </li>
          </ul>
        </div>
